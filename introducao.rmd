...
df1 <- data.frame(Nome = c("Mônica", "Ross", "Rachel"),
                  Bananas = c(1,2,5),
                  Peras = c(3, 8, 2),
                  Cenouras= c(5, 7, 0))

kable(df1, caption="Lista de compras",align="cr")
...
Além disso, precisamos de um método **seguro** para manipular esses dados. Já imaginou, por um erro de digitação, apagar alguma célula importante em uma planilha? Ou fazer uma manipulação equivocada e não ter como resgatar a versão anterior? O R! previne contra todas essas situações.
